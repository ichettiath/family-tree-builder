...
(FamilyTree._defaultConfig = function (e) {
            ...
            for (var m = 0; m < e.length; m++)
               for (var h in i[m]) {
                  ...
                  switch (h.toLowerCase()) {
                     case "d":
                        var f =
                              a((d * s - s) / r) * (i[m][h][0] - t[m][h][0]) +
                              t[m][h][0],
                           u =
                              a((d * s - s) / r) * (i[m][h][1] - t[m][h][1]) +
                              t[m][h][1];
                        e[m].setAttribute(
                           "d",
               ...
               if (i && i.hasAttribute) {
                  ...
                  switch (n) {
                     case "edit":
                        ...
                        break;
                     case "pdf":
                        r.obj.exportPDFProfile({ id: e, filename: a.title }),
                           r.hide();
                        break;
                     case "png":
                        r.obj.exportPNGProfile({ id: e, filename: a.title }),
                           r.hide();
                        break;
                     case "share":
            ...
            if ("svg" == e.ext)
               if (t) t(e, n.innerHTML);
                  ...
                  if (
                     ...
                     return !1;
                  if (
                     !1 === (d = FamilyTree.events.publish("exportend", [i, s]))
                  )
                     return !1;
                     ...
                     t
                        ...
                        : ((a = JSON.stringify(a)),
                          FamilyTree._ajax(
                             ...
                             "arraybuffer",
                             function (t) {
                                var r = FamilyTree.events.publish("exportend", [
                                   i,
                                   t
                                ]);
                                if ((FamilyTree.loading.hide(i), !1 === r))
                                   return !1;
                                FamilyTree._downloadFile(
                                   e.mime,
                                   t,
      ...
      if (!FamilyTree.EXPORT_PAGES_CUT_NODES && "fit" == e.scale) {
         ...
         for (var _ = 0, w = 0; ; ) {
            for (w = _; !(F <= _); ) {
               ...
               if (
                  (_ == F - 1 && (k = (b[_].maxY - b[w].minY) / (100 / i)),
                  k > m.h)
               )
                  break;
               _++;
            ...
            (document.onmousemove = function (e) {
               (e = e || window.event),
                  a._dragging &&
                     ...
                     (a.style.top =
                        a._originalTop + e.clientY - a._mouseTop + "px"));
            }),
   ...
   (FamilyTree.prototype._globalClickHandler = function (e, t) {
      ...
      for (var l = t.target; l != e; ) {
         ...
         if (l.hasAttribute(FamilyTree.attr.control_up_id)) {
            ...
            return (
               t.stopPropagation(), t.preventDefault(), void this._upHandler(s)
            );
         }
            ...
            if (C) {
               ...
               if (c.left || c.right || c.up || c.down) {
                  ...
                  if (
                     ...
                     if (
                        (!1 ===
                           FamilyTree.events.publish("drag", [r, a, t, n]) &&
                           L(),
                        r.config.enableDragDrop)
                     )
   ...
   (FamilyTree.manager._createNodes = function (e) {
      ...
      if (
         ...
         for (var T = l[a.id]; T; ) {
            if (
               (y.push(T.id),
               a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS &&
                  T)
            )
                  ...
                  if (
                     ...
                     for (c = 0; c < pe.childrenIds.length; c += ge) {
                        ...
                        for (b = 0; b < ge; b++) {
                           ...
                           ((D = l[(de = pe.childrenIds[c + b])]).parent =
                              l[ye]),
      ...
      if (
         ...
         switch (r.orientation) {
            ...
            case FamilyTree.orientation.left:
               (w = -r.padding),
                  (k =
                     u.y - _ / 2 + FamilyTree.manager._getNodeWidth(u, r) / 2);
               break;
            case FamilyTree.orientation.right:
               (w = r.padding - x),
                  (k =
         ...
         for (g = 0; g < e.children.length; g++) {
            ...
            if (T.isChildOfPartner)
               switch (s.orientation) {
                  ...
                  case FamilyTree.orientation.top_left:
                     var _ =
                        1 == T.layout ? void 0 : b.minY - (b.minY - u.maxY) / 2;
                  ...
                  case FamilyTree.orientation.bottom_left:
                     _ =
                        1 == T.layout ? void 0 : b.maxY - (b.maxY - u.minY) / 2;
                  ...
                  case FamilyTree.orientation.right_top:
                     _ =
                        1 == T.layout ? void 0 : b.maxX - (b.maxX - u.minX) / 2;
                  ...
                  case FamilyTree.orientation.left_top:
                     _ =
                        1 == T.layout ? void 0 : b.minX - (b.minX - u.maxX) / 2;
            ...
            for (; null == d; ) {
               ...
               if (!v) {
                  ...
                  if (T.parent) {
                     ...
                     var w =
                        e.manager.bordersByRootIdAndLevel[g.id][T.parent.sl];
                     switch (h.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
                           _ = w.maxY + f * (2 / 3);
   ...
   FamilyTree.events.on("redraw", function (e, t) {
      if (e.config.groupDottedLines.length) {
         for (
            var i = e.element.querySelectorAll("[data-ctrl-n-dotted-close]"),
               r = 0;
            r < i.length;
            r++
         )
      ...
      for (var m = {}, h = 0; h < e.length; h++)
         for (var p = e[h], f = 0; f < i.length; f++) {
            ...
            if (!FamilyTree.isNEU(p[u])) {
               ...
               if (
                  null !=
                  (t = FamilyTree._search.searchAndComputeScore(d, y, u, n))
               ) {
                  var g = p.id;
                  if (m[g]) {
   ...
   (FamilyTree.filterUI.prototype.update = function () {
      if (this.instance.config.filterBy) {
         ...
         if ("all" == this.instance.config.filterBy)
            for (
               var t = FamilyTree.manager.getAllFields(this.instance.config),
                  i = 0;
               i < t.length;
               i++
            ) {
                           ...
                           if (t) {
                              ...
                              if (e.target.hasAttribute("data-all")) {
                                 for (
                                    ...
                                    if (r[a] != e.target)
                                       for (var n in ((r[a].checked =
                                          e.target.checked),
                                       p.filterBy[i]))
                                          p.filterBy[i][n].checked =
                                             e.target.checked;
                              } else if (
                                 (null != p.filterBy[i][this.name] &&
                                    (p.filterBy[i][this.name].checked =
                                       this.checked),
                                 this.checked)
                              )
                                 for (
...
(FamilyTree.remote._convertToIdArray = function (e) {
   ...
   (FamilyTree.remote._proceed = function (e, t, i, r) {
      if (
         ("string" == typeof t && (t = JSON.parse(t)), t.limit && 1 == t.limit)
      )
         r(t.limit);
      else {
         for (var a = 0; a < e.length; a++)
